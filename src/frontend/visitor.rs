...
use super::{stmt::{ExprStmt, VarDeclStmt, ReturnStmt, BlockStmt, IfStmt, WhileStmt}, expr::{VariableExpr, VarAssignExpr}};
...
pub trait Visitor<'ctx> {
    ...
    fn visit_while_stmt(&mut self, expr: &WhileStmt<'ctx>);
}
